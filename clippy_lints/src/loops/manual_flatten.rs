...
use clippy_utils::{is_ok_ctor, is_some_ctor, path_to_local_id, peel_expr_or_stmt_blocks};
use if_chain::if_chain;
use rustc_errors::Applicability;
use rustc_hir::{Expr, ExprKind, MatchSource, Pat, PatKind, QPath};
...
pub(super) fn check<'tcx>(
    ...
    let inner_expr = peel_expr_or_stmt_blocks(body);
    if_chain! {
        ...
        then {let if_let_type = if some_ctor { "Some" } else { "Ok" };
