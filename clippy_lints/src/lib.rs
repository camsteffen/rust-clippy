...
use passes::{ClippyCombinedEarlyLintPass, ClippyCombinedLateLintPass};
...
pub fn register_plugins(store: &mut rustc_lint::LintStore, sess: &Session, conf: &Conf) {
    ...
    // todo `no_interleave_lints`
    store.register_lints(&ClippyCombinedEarlyLintPass::get_lints());
    store.register_lints(&ClippyCombinedLateLintPass::get_lints());
    store.register_early_pass(|| box ClippyCombinedEarlyLintPass::new());
    store.register_late_pass(|| box ClippyCombinedLateLintPass::new());
